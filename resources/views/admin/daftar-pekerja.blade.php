...
@section('content')
<br>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addModalPekerja">
    Tambah Pekerja
</button>
<br><br>
<div class="row">
                ...
                <tr>
                  ...
                  <td>                      
                    <button class="btn btn-info" data-toggle="modal" data-id="{{$item->id}}" data-name="{{$item->name}}"
                      ...
                      data-tel="{{$item->detailPekerja->tel}}" data-alamat="{{$item->detailPekerja->alamat}}" data-keahlian="{{$item->detailPekerja->keahlian}}"
                      data-agama="{{$item->detailPekerja->agama}}" data-tanggalmasuk="{{$item->detailPekerja->tanggalMasuk}}" data-fotodiri="{{$item->detailPekerja->fotoDiri}}" 
                      data-fotoktp="{{$item->detailPekerja->fotoKTP}}" data-rating="{{$item->detailPekerja->rating}}" data-target="#editModalPekerja">Edit</button>
                             / 
                      <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModalPekerja" data-id="{{$item->id}}">Hapus</button>                      
                  </td>
                </tr>
                @endforeach
