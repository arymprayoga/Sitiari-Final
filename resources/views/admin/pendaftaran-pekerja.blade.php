...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Pekerja Yang Mendaftar</h3>
        </div>
        ...
        <table class="table table-hover text-center">
          ...
          <input type="hidden" name="id" value="{{$item->id}}">
            <tr>
              ...
              <td>
                <button class="btn btn-primary" data-toggle="modal" data-target="#terimaModalDaftar" data-id="{{$item->id}}">Terima</button> / 
                <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModalDaftar" data-id="{{$item->id}}">Tolak</button>
              </td>
            </tr>
            @endforeach
          </tbody>
...
{{-- Delete Modal --}}
<div class="modal modal-danger fade" id="deleteModalDaftar" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteModalDaftarLabel">Konfirmasi Tolak Resign</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{route('user.tolak-pekerja')}}" method="post">
          {{csrf_field()}}
          <div class="modal-body">
              <h5 class="text-center"> Yakin akan menolak pendaftaran dari pekerja ini?</h5>
...
{{-- Terima Modal --}}
<div class="modal modal-danger fade" id="terimaModalDaftar" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="terimaModalDaftarLabel">Konfirmasi Terima Pekerja</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{route('user.terima-pekerja')}}" method="post">
          {{csrf_field()}}
          <div class="modal-body">
              <h5 class="text-center"> Yakin akan menerima pendaftaran dari pekerja ini?</h5>
              <input type="hidden" name="id" id="idDelete" value="">
          </div>
          <div class="modal-footer">
              <button button type="button" class="btn btn-secondary">Tidak</button>
